...
;Bonus Variables:
draw_card: .res 1
animation_step: .res 1
hole_card_x: .res 1
hole_card_y: .res 1
destination_slot: .res 1
...
JMP done
:
LDX destination_slot
CLC
LDA animated_card_step, X
STA animation_step
LDA hole_card_x
SBC animation_step
STA hole_card_x
CLC
LDA animated_card_step + 1, X
STA animation_step
LDA hole_card_y
SBC animation_step
STA hole_card_y
...
;Bonus Animation:-----------
  ...
  LDA card_val, X      ; Usa X para indexar a traves de la rutina `card_val`
  STA placecard_value
...
;Verifica si automaticamente el player se pasa de 21 -PIERDE INSTANTANEAMENTE LA RONDA:
...
; Redraw Background and reset card and position indexes.
JSR Background
;JSR ClearWinLossSprites  ;Clear Win or Loss Sprites 
...
; Animated Card steps and destination with respect to the slot position
; (step_x, step_y)
animated_card_step:
.byte $01, $03
